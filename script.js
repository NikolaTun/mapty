...
// const cycling1 = new Cycling([39, -12], 27.2, 95, 532);
...
class App {
  ...
  // _removeWorkout(e) {
  //   // Attach event to X button
  //   const removeBtnEl = e.target.closest('.remove__btn');
  //   // Attach X button to its workout
  //   const workoutToRemove = removeBtnEl.closest('.workout');
  //   //  Remove the workout
  //   workoutToRemove.style.display = 'none';
  ...
  //   //   work => work.id === removeBtnEl.dataset.id
  //   // );
